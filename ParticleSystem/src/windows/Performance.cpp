...
void Performance::Render()
{
	...
	ImGui::Text(
		"Update time (CPU): %lld (min: %lld, avg: %lld; max: %lld)",
	...
	ImGui::Text(
		"Render time (CPU): %lld (min: %lld, avg: %lld; max: %lld)",
	...
	ImGui::Text(
		"Render time (GPU): %lld (min: %lld, avg: %lld; max: %lld)",
